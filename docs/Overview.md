...
+ **Low-friction Integration**: The protocol is designed to be compatible with existing commercial systems and payment infrastructure. This enables seamless integration among all AMP participants while minimizing changes to their existing infrastructure.
+ **Openness and Interoperability**: The protocol is not bound to any specific platform, model, or technology stack, and supports multiple implementation approaches. This enables diverse service providers to connect, ensuring that AMP participants can interoperate openly.
...
![](images/Figure%201.%20AMP%20framework.png)
