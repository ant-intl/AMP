...
|  | Delegation Limit Management | Enables the User to configure transaction limits, usage limits, and other control parameters that govern delegated authorization within the digital wallet. |
...
![Figure 2. Main workflow of Direct Payment (Human-Present)](images/Figure%202.%20Main%20workflow%20of%20Direct%20Payment%20%28Human-Present%29.png)
...
![Figure 3. User experience sample of binding a wallet account](images/Figure%203.%20User%20experience%20sample%20of%20binding%20a%20wallet%20account.png)
...
![Figure 4. User experience sample of confirming order and payment](images/Figure%204.%20User%20experience%20sample%20of%20confirming%20order%20and%20payment.png)
...
Based on the authorized User Intent issued Mandate, the Agent requests a Payment Token from Alipay+ through the CP. This step **MUST** comply with the requirements for [Payment Token Request](payment#ggPzK) in the Payment Service Domain.
...
The Merchant is recommended to verify the L1 and L2 signatures before proceeding with the payment process. The Merchant continues payment processing after the relevant verification checks have been successfully completed. This verification step **MUST** comply with the requirements for [Assurance Data Management](intent#gwpyL) in the Intent Trust Domain.

After verification succeeds, the Merchant forwards the Payment Token to Alipay+ through the Acquirer to complete the final payment. This step **MUST** comply with the requirements for [Payment Processing in the Direct Payment (Human-Present)](payment#D9I5a) in the Payment Service Domain.
...
![Figure 5. Main workflow of Delegated Payment (Human-Not-Present)](images/Figure%205.%20Main%20workflow%20of%20Delegated%20Payment%20%28Human-Not-Present%29.png)
...
![Figure 6. User experience sample of binding a wallet account](images/Figure%206.%20User%20experience%20sample%20of%20binding%20a%20wallet%20account.png)
...
![Figure 7. User experience sample of confirming an order](images/Figure%207.%20User%20experience%20sample%20of%20confirming%20an%20order.png)
...
This step **MUST** comply with the requirements for [Assurance Data Management](intent#gwpyL) in the Intent Trust Domain and for [Payment Processing in Delegated Payment (Human-Not-Present)](payment#JDQLL) in the Payment Service Domain.
